...
public class Task1 {
    public static void main(String[] args) {
        ...
        */
        ...
        System.out.println(names.contains("Jam")); // Check if the given value in the ArrayList
        System.out.println(names.contains("Dam"));
        System.out.println(names.size());          // Returns the length (size) of the ArrayList
        System.out.println(names);                 // Prints all values in the ArrayList.
    }
}
